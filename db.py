...
DB_NAME = 'da39rmke9ic877'
DB_HOST = 'ec2-23-23-110-26.compute-1.amazonaws.com'
DB_USER = os.environ['DATABASE_USER']
DB_PASS = os.environ['DATABASE_PASS']


def create_table():
    conn = psycopg2.connect(user=os.environ['DATABASE_USER'], password=os.environ['DATABASE_PASS'],
                            host='ec2-23-23-110-26.compute-1.amazonaws.com', dbname='da39rmke9ic877')
    c = conn.cursor()
